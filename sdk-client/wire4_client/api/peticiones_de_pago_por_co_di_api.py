...
class PeticionesDePagoPorCoDiApi(object):
    ...
    def consult_codi_request_by_order_id_with_http_info(self, authorization, order_id, sales_point_id, **kwargs):  # noqa: E501
        ...
        if 'sales_point_id' in params:
            path_params['sales_point_id'] = params['sales_point_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/codi/sales-point/{sales_point_id}/charges/{order_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def generate_codi_code_qr_with_http_info(self, body, authorization, sales_point_id, **kwargs):  # noqa: E501
        ...
        path_params = {}
        if 'sales_point_id' in params:
            path_params['salesPointId'] = params['sales_point_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/codi/sales-point/{salesPointId}/charges', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
