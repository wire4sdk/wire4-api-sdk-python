...
class PuntosDeVentaCoDiApi(object):
    ...
    def create_sales_point(self, body, authorization, company_id, **kwargs):  # noqa: E501
        """Registra un punto de venta asociado a una empresa  # noqa: E501

        Registra un punto de venta desde donde se emitaran los cobros CODI®, el punto de venta se debe asociar a un cuenta cableregistrada previamente ante Banxico para realizar cobros con CODI®  # noqa: E501
        ...
        :param SalesPointRequest body: salesPointRequest (required)
        :param str authorization: Header para token (required)
        :param str company_id: company_id (required)
        :param str name:
    ...
    def create_sales_point_with_http_info(self, body, authorization, company_id, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'authorization', 'company_id', 'name']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/codi/companies/{company_id}/salespoint', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def obtain_sale_points(self, authorization, company_id, **kwargs):  # noqa: E501
        """Obtiene los puntos de venta asociados a una empresa  # noqa: E501
        ...
        :param async_req bool
        :param str authorization: Header para token (required)
        :param str company_id: El identificador de la empresa (required)
    ...
    def obtain_sale_points_with_http_info(self, authorization, company_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/codi/companies/{company_id}/salespoint', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
