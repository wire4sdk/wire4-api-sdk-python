...
class OperacionesCoDiApi(object):
    ...
    def consult_codi_operations(self, authorization, **kwargs):  # noqa: E501
        ...
        :param str company_id: Identificador de empresa CoDi
        :param str page: Número de pago
        :param str sales_point_id: Identificador del punto de venta
        :param str size: Tamaño de pagina
