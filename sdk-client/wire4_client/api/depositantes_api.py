...
class DepositantesApi(object):
    ...
    def update_status_depositants_no_suscrption_using_patch(self, authorization, account, action, **kwargs):  # noqa: E501
        """Solicitud para actualizar el estado de un depositante sin utilizar la suscripción  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_status_depositants_no_suscrption_using_patch(authorization, account, action, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: Header para token (required)
        :param str account: Es la cuenta que va a ser actualizada. (required)
        :param str action: Es la cuenta que va a ser actualizada. (required)
        :param str body: Empty value
        :return: Depositant
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_status_depositants_no_suscrption_using_patch_with_http_info(authorization, account, action, **kwargs)  # noqa: E501
        else:
            (data) = self.update_status_depositants_no_suscrption_using_patch_with_http_info(authorization, account, action, **kwargs)  # noqa: E501
            return data

    def update_status_depositants_no_suscrption_using_patch_with_http_info(self, authorization, account, action, **kwargs):  # noqa: E501
        """Solicitud para actualizar el estado de un depositante sin utilizar la suscripción  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_status_depositants_no_suscrption_using_patch_with_http_info(authorization, account, action, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'account', 'action', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_status_depositants_no_suscrption_using_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `update_status_depositants_no_suscrption_using_patch`")  # noqa: E501
        # verify the required parameter 'account' is set
        if ('account' not in params or
                params['account'] is None):
            raise ValueError("Missing the required parameter `account` when calling `update_status_depositants_no_suscrption_using_patch`")  # noqa: E501
        # verify the required parameter 'action' is set
        if ('action' not in params or
                params['action'] is None):
            raise ValueError("Missing the required parameter `action` when calling `update_status_depositants_no_suscrption_using_patch`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/depositants/{account}/{action}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='Depositant',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_status_depositants_using_patch(self, authorization, account, action, **kwargs):  # noqa: E501
        """Solicitud para actualizar el estado de un depossitante  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_status_depositants_using_patch(authorization, account, action, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_status_depositants_using_patch_with_http_info(authorization, account, action, **kwargs)  # noqa: E501
        else:
            (data) = self.update_status_depositants_using_patch_with_http_info(authorization, account, action, **kwargs)  # noqa: E501
            return data

    def update_status_depositants_using_patch_with_http_info(self, authorization, account, action, **kwargs):  # noqa: E501
        """Solicitud para actualizar el estado de un depossitante  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_status_depositants_using_patch_with_http_info(authorization, account, action, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_status_depositants_using_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `update_status_depositants_using_patch`")  # noqa: E501
        # verify the required parameter 'account' is set
        if ('account' not in params or
                params['account'] is None):
            raise ValueError("Missing the required parameter `account` when calling `update_status_depositants_using_patch`")  # noqa: E501
        # verify the required parameter 'action' is set
        if ('action' not in params or
                params['action'] is None):
            raise ValueError("Missing the required parameter `action` when calling `update_status_depositants_using_patch`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/subscriptions/{subscription}/depositants/{account}/{action}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
