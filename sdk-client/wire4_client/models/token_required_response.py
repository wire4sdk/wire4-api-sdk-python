...
class TokenRequiredResponse(object):
    ...
    def __init__(self, request_id=None, url=None):  # noqa: E501
        """TokenRequiredResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def request_id(self):
        """Gets the request_id of this TokenRequiredResponse.  # noqa: E501

        Es el identificador público generado para la petición (solicitud).  # noqa: E501

        :return: The request_id of this TokenRequiredResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this TokenRequiredResponse.

        Es el identificador público generado para la petición (solicitud).  # noqa: E501

        :param request_id: The request_id of this TokenRequiredResponse.  # noqa: E501
        :type: str
        """
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this TokenRequiredResponse.

        Es la dirección URL generada para confirmación de la operación. Es para ingresar al centro de autorización.  # noqa: E501

        :param url: The url of this TokenRequiredResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokenRequiredResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenRequiredResponse):
            return False
