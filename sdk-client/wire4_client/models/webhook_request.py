...
class WebhookRequest(object):
    ...
    def __init__(self, events=None, name=None, url=None):  # noqa: E501
    ...
    def events(self):
        ...
        Son los eventos para que Wire4 te envíe información. Para más información sobre los tipos de eventos soportados, revise la siguiente liga: <a href=\"#section/Eventos\">https://developers.wire4.mx/#section/Eventos</a>.  # noqa: E501
    ...
    def url(self):
        ...
        Es la dirección URL para que Wire4 envíe las notificaciones cuando un evento ocurra.  # noqa: E501
