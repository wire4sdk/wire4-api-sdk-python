...
class WebHookDepositAuthorizationRequest(object):
    ...
    def __init__(self, name=None, url=None):  # noqa: E501
        """WebHookDepositAuthorizationRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._url = None
    ...
    @property
    def name(self):
        """Gets the name of this WebHookDepositAuthorizationRequest.  # noqa: E501

        Es el nombre del webhook.  # noqa: E501

        :return: The name of this WebHookDepositAuthorizationRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this WebHookDepositAuthorizationRequest.

        Es el nombre del webhook.  # noqa: E501

        :param name: The name of this WebHookDepositAuthorizationRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this WebHookDepositAuthorizationRequest.  # noqa: E501

        Es la dirección URL a la cuál Wire4 enviará las notificaciones cuando un evento ocurra.  # noqa: E501

        :return: The url of this WebHookDepositAuthorizationRequest.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this WebHookDepositAuthorizationRequest.

        Es la dirección URL a la cuál Wire4 enviará las notificaciones cuando un evento ocurra.  # noqa: E501

        :param url: The url of this WebHookDepositAuthorizationRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WebHookDepositAuthorizationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebHookDepositAuthorizationRequest):
            return False
