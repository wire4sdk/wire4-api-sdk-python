...
class MessageAccountBeneficiary(object):
    ...
    def account(self):
        ...
        Es la cuenta del beneficiario registrado.  # noqa: E501
    ...
    def error_message(self):
        ...
        Es el mensaje de error que se informa en caso de existir uno.  # noqa: E501
    ...
    def request_id(self):
        ...
        Es el identificador en esta API de la petición de registro de la cuenta del beneficiario.  # noqa: E501
