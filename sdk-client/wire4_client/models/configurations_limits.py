...
class ConfigurationsLimits(object):
    ...
    def __init__(self, group=None, items=None):  # noqa: E501
        """ConfigurationsLimits - a model defined in Swagger"""  # noqa: E501
        self._group = None
        self._items = None
    ...
    @property
    def group(self):
        """Gets the group of this ConfigurationsLimits.  # noqa: E501

        Nombre del grupo de configuraciones. Debe ser LIMIT_BY_TIME para especificar la configuración por límite por horario, LIMIT_BY_RANGE para especificar límite por periodo o LIMIT_BY_SCHEDULE para especificar el horario de operaciones  # noqa: E501

        :return: The group of this ConfigurationsLimits.  # noqa: E501
        :rtype: str
        """
        return self._group
    ...
    def group(self, group):
        """Sets the group of this ConfigurationsLimits.

        Nombre del grupo de configuraciones. Debe ser LIMIT_BY_TIME para especificar la configuración por límite por horario, LIMIT_BY_RANGE para especificar límite por periodo o LIMIT_BY_SCHEDULE para especificar el horario de operaciones  # noqa: E501

        :param group: The group of this ConfigurationsLimits.  # noqa: E501
        :type: str
        """
    ...
    @property
    def items(self):
        """Gets the items of this ConfigurationsLimits.  # noqa: E501

        Lista de items configurados  # noqa: E501

        :return: The items of this ConfigurationsLimits.  # noqa: E501
        :rtype: list[Item]
        """
        return self._items
    ...
    def items(self, items):
        """Sets the items of this ConfigurationsLimits.

        Lista de items configurados  # noqa: E501

        :param items: The items of this ConfigurationsLimits.  # noqa: E501
        :type: list[Item]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigurationsLimits, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigurationsLimits):
            return False
