...
class CepSearchBanxico(object):
    ...
    def beneficiary_account(self):
        ...
        Cuenta de beneficiario  # noqa: E501
    ...
    def beneficiary_bank_key(self):
        ...
        Clave del banco beneficiario, se puede obtener este valor del listado de institucines '/institutions'. Si este valor no esta presente se obtiene de la cuenta del beneficiario, si la cuenta de beneficiario es un número celular este campo es requerido  # noqa: E501
    ...
    def operation_date(self):
        ...
        Fecha de operación de la transferencia, formato: dd-MM-yyyy  # noqa: E501
    ...
    def sender_account(self):
        ...
        Cuenta ordenante, es requerida cuando se no se envía la clave del banco ordenante   # noqa: E501
    ...
    def sender_bank_key(self):
        ...
        Clave del banco ordenante, se puede obtener este valor del listado de institucines '/institutions'. Es requerida cuando no se envía la cuenta ordenante  # noqa: E501
