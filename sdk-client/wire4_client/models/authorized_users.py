...
class AuthorizedUsers(object):
    ...
    def __init__(self, account=None, masked_account=None, masked_name=None, masked_user_name=None, name=None, user_name=None):  # noqa: E501
        """AuthorizedUsers - a model defined in Swagger"""  # noqa: E501
        self._account = None
    ...
    @property
    def account(self):
        """Gets the account of this AuthorizedUsers.  # noqa: E501

        El contrato al cual se le brinda el acceso a la API  # noqa: E501

        :return: The account of this AuthorizedUsers.  # noqa: E501
        :rtype: str
        """
    ...
    def account(self, account):
        """Sets the account of this AuthorizedUsers.

        El contrato al cual se le brinda el acceso a la API  # noqa: E501

        :param account: The account of this AuthorizedUsers.  # noqa: E501
        :type: str
        """
    ...
    def masked_account(self):
        """Gets the masked_account of this AuthorizedUsers.  # noqa: E501

        El contrato enmascarado al cual se le brinda el acceso a la API  # noqa: E501

        :return: The masked_account of this AuthorizedUsers.  # noqa: E501
        :rtype: str
        """
    ...
    def masked_account(self, masked_account):
        """Sets the masked_account of this AuthorizedUsers.

        El contrato enmascarado al cual se le brinda el acceso a la API  # noqa: E501

        :param masked_account: The masked_account of this AuthorizedUsers.  # noqa: E501
        :type: str
        """
    ...
    def masked_name(self):
        """Gets the masked_name of this AuthorizedUsers.  # noqa: E501

        El usuario enmascarado que se autorizó  # noqa: E501

        :return: The masked_name of this AuthorizedUsers.  # noqa: E501
        :rtype: str
        """
    ...
    def masked_name(self, masked_name):
        """Sets the masked_name of this AuthorizedUsers.

        El usuario enmascarado que se autorizó  # noqa: E501

        :param masked_name: The masked_name of this AuthorizedUsers.  # noqa: E501
        :type: str
        """
    ...
    def masked_user_name(self):
        """Gets the masked_user_name of this AuthorizedUsers.  # noqa: E501

        El nombre enmascarado del usuario de acceso que se autorizó  # noqa: E501

        :return: The masked_user_name of this AuthorizedUsers.  # noqa: E501
        :rtype: str
        """
    ...
    def masked_user_name(self, masked_user_name):
        """Sets the masked_user_name of this AuthorizedUsers.

        El nombre enmascarado del usuario de acceso que se autorizó  # noqa: E501

        :param masked_user_name: The masked_user_name of this AuthorizedUsers.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this AuthorizedUsers.  # noqa: E501

        El usuario que se autorizó  # noqa: E501

        :return: The name of this AuthorizedUsers.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AuthorizedUsers.

        El usuario que se autorizó  # noqa: E501

        :param name: The name of this AuthorizedUsers.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_name(self):
        """Gets the user_name of this AuthorizedUsers.  # noqa: E501

        El usuario de acceso que se autorizó  # noqa: E501

        :return: The user_name of this AuthorizedUsers.  # noqa: E501
        :rtype: str
        """
    ...
    def user_name(self, user_name):
        """Sets the user_name of this AuthorizedUsers.

        El usuario de acceso que se autorizó  # noqa: E501

        :param user_name: The user_name of this AuthorizedUsers.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuthorizedUsers, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthorizedUsers):
            return False
