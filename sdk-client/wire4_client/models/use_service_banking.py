...
class UseServiceBanking(object):
    ...
    def __init__(self, status=None, use=None):  # noqa: E501
        """UseServiceBanking - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._use = None
    ...
    @property
    def status(self):
        """Gets the status of this UseServiceBanking.  # noqa: E501

        Estatus que se le asigna a la subscripción  # noqa: E501

        :return: The status of this UseServiceBanking.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this UseServiceBanking.

        Estatus que se le asigna a la subscripción  # noqa: E501

        :param status: The status of this UseServiceBanking.  # noqa: E501
        :type: str
        """
        if status is None:
    ...
    @property
    def use(self):
        """Gets the use of this UseServiceBanking.  # noqa: E501

        Uso que se le desea dar a la subscripción  # noqa: E501

        :return: The use of this UseServiceBanking.  # noqa: E501
        :rtype: str
        """
        return self._use
    ...
    @use.setter
    def use(self, use):
        """Sets the use of this UseServiceBanking.

        Uso que se le desea dar a la subscripción  # noqa: E501

        :param use: The use of this UseServiceBanking.  # noqa: E501
        :type: str
        """
        if use is None:
            raise ValueError("Invalid value for `use`, must not be `None`")  # noqa: E501
        allowed_values = ["WITHDRAWAL_DEPOSIT", "WITHDRAWAL", "DEPOSIT"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UseServiceBanking, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UseServiceBanking):
            return False
