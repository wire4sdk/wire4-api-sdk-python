...
class Webhook(object):
    ...
    def events(self):
        ...
        Tipo de evento manejado por el webhook, para mas referencia sobre los tipos de eventos soportados, revise la siguiente liga: https://developers.wire4.mx/#section/Eventos.  # noqa: E501
    ...
    def secret(self):
        ...
        Llave con la cual se debe de identificar que el webhook fue enviado por Wire4, para mayor información revisar la guía de notificaciones (https://wire4.mx/#/guides/notificaciones), en la sección de  \"Comprobación de firmas de Webhook\".  # noqa: E501
    ...
    def status(self):
        ...
        Estatus en el que se encuentra el webhook.  # noqa: E501
    ...
    def url(self):
        ...
        URL a la cual Wire4 enviará las notificaciones cuando un evento ocurra.  # noqa: E501
