...
class CodiCodeQrResponseDTO(object):
    ...
    def barcode_url(self):
        ...
        La URL del código QR  # noqa: E501
    ...
    def creation_date(self):
        ...
        Fecha de creación del código QR para pago CODI®  # noqa: E501
    ...
    def due_date(self):
        ...
        Fecha de operación del pago CODI®  # noqa: E501
    ...
    def phone_number(self):
        ...
        Número de teléfono móvil en caso de ser un pago CODI® usando 'PUSH_NOTIFICATION'  # noqa: E501
