...
class AccountSpid(object):
    ...
    def bank_code_banxico(self):
        ...
        Código banxico con una longitud de 5 dígitos, es requerido en caso de que la cuenta del beneficiario sea un número de celular  # noqa: E501
    ...
    def cancel_return_url(self):
        ...
        Url a la que se redirigira en caso no exitoso  # noqa: E501
    ...
    def kind_of_relationship(self):
        ...
        Tipo de relación de la cuentaobtained of endpoint relationships  # noqa: E501
    ...
    def relationship(self):
        ...
        Código de relación de la cuenta, este valor debe ser igual a un valor obtenido del endpoint relationship  # noqa: E501
